...
vasmm68k.exe -no-opt -quiet -Fbin -I 68000 -DATARI -o 68000\depacker.bin 68000\depacker.asm
if errorlevel 1 goto error
vasmm68k.exe -no-opt -quiet -Fbin -I 68000 -DATARI -o 68000\depacker_absolute.bin 68000\depacker_absolute.asm
if errorlevel 1 goto error
...
vasmm68k.exe -no-opt -quiet -Fbin -I 68000 -DX68000 -o 68000\depacker.bin 68000\depacker.asm
if errorlevel 1 goto error
vasmm68k.exe -no-opt -quiet -Fbin -I 68000 -DX68000 -o 68000\depacker_absolute.bin 68000\depacker_absolute.asm
if errorlevel 1 goto error
